...
type updatePodFunc func(controller *apiv1.Pod, value string)

// updatePodWithRetries retries updating the given pod on conflict with the following steps:
// 1. Get latest resource
// 2. applyUpdate
// 3. Update the resource
func updatePodWithRetries(namespace string, pod *apiv1.Pod, newvalue string, applyUpdate updatePodFunc) (*apiv1.Pod, error) {
